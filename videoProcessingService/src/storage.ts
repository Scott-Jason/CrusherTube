...
// 2. keeps track of local file interactions as well
...
const processedVideoBucketName = "climbing-processed-videos";
...
function ensureDirectoryExists(dirPath: string) {
    if (!fs.existsSync(dirPath)) {
        fs.mkdirSync(dirPath, {recursive: true }); //recursive: true enables created nested dirs
